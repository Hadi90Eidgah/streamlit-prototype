...
def create_network_visualization(nodes_df, edges_df, network_id, grant_id=None, treatment_name=None):
    ...
    fig.update_layout(
        ...
        legend=dict( orientation="h",yanchor="top",y=-0.15, xanchor="center", x=0.5, bgcolor="rgba(45, 55, 72, 0.9)", bordercolor="rgba(74, 85, 104, 0.5)", borderwidth=1, font=dict(size=11, color='#e2e8f0'))
    )
